...
const Dashbord = () => {
    ...
    switch (step) {
        case 1:
          return <BasicInfo  setStep={setStep} step={step} useFormik={useFormik} />;
        case 2:
          return <JobIssues  setStep={setStep} step={step} useFormik={useFormik} />;
        case 3:
          return <Contact  setStep={setStep} step={step} useFormik={useFormik} />;
        case 4:
          return <Verfication  setStep={setStep} step={step} useFormik={useFormik} />;
