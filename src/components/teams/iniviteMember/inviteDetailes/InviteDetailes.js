        ...
        <div>
            ...
            {members.map((item,index)=>{
                return <div className={styles.invite}>
                    <input className={styles.invite_input} key={index} onChange={(e)=>phoneHandler(e,index)} placeholder="شماره فرد مورد نظر برای دعوت به تیم را وارد کنید."/>
                    <div className={styles.send_phone} onClick={()=>inviteHandler(index)}><p>ارسال دعوت نامه</p></div>
                </div>
            })}
