export const fistContracts=[
 ...
 export const secondContracts=[
    {name:"قرارداد استخدام برنامه نویس موبایل" ,id:1,className:"contract"},
    {name:"قرارداد استخدام مدیر محصول",id:2, className:"contract"},
    {name:"قرارداد استخدام کارشناس تولید محتوا" ,id:3,className:"contract"},
